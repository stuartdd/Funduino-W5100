                ...
                "xhttp.onreadystatechange = function () {"
                    "if (this.readyState === 4 && this.status === 200) {"
                        ...
                        "} else {"
                            ...
                            "}"
                            "document.getElementById(\"tabSA\").innerHTML = obj.sa;"
                            "document.getElementById(\"tabSB\").innerHTML = obj.sb;"
                            "document.getElementById(\"sense0\").innerHTML = obj.d0;"
                            "document.getElementById(\"sense1\").innerHTML = obj.d1;"
                            "document.getElementById(\"tabA0\").innerHTML = obj.t0;"
                            "document.getElementById(\"tabA1\").innerHTML = obj.t1;"
                            "document.getElementById(\"tabA2\").innerHTML = obj.v0;"
                            "document.getElementById(\"tabA3\").innerHTML = obj.v1;"
                        "}"
                    "}"
                "};"
