                ...
                "xhttp.onreadystatechange = function () {"
                    "if (this.readyState === 4 && this.status === 200) {"
                        ...
                        "} else {"
                            ...
                            "document.getElementById(\"tabA0\").innerHTML = obj.on.a0;"
                            "document.getElementById(\"tabA1\").innerHTML = obj.on.a1;"
                            "document.getElementById(\"tabA2\").innerHTML = obj.on.a2;"
                            "document.getElementById(\"tabA3\").innerHTML = obj.on.a3;"
                        "}"
                    "}"
                "};"
